locale = {
  ...
  translation = {
    ...
    ["Hide monsters"] = "Esconder pokemons",
	...
	["Pokemon info"] = "Informações do pokemon",
    ["Port"] = "Porta",
    ["Position"] = "Posição",
    ...
    ["Skills"] = "Habilidades",
    ["Sorcerer"] = "Sorcerer",
    ["Soul Points"] = "Pokemons capturados",
    ["Soul"] = "Capturas",
    ["Special"] = "Especial",
    ["Speed"] = "Velocidade",
    ["Spell Cooldowns"] = "",
    ...
    ["Your character mana is %d out of %d."] = "Você tem %d pokemon de %d.",
    ["Your character manas is %d out of %d.."] = "Você tem %d pokemons",
